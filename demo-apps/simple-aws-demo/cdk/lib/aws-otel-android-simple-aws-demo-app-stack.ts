...
export class AwsOtelAndroidSimpleAwsDemoAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    // Create an S3 bucket for the demo app
    const demoBucket = new s3.Bucket(this, 'AwsOtelAndroidDemoBucket', {
    ...
    const identityPool = new cognito.CfnIdentityPool(this, 'AwsOtelAndroidDemoIdentityPool', {
      allowUnauthenticatedIdentities: true, // Allow unauthenticated identities for demo purposes
      identityPoolName: 'aws-otel-android-demo-identity-pool',
    });
    ...
    const appMonitor = new rum.CfnAppMonitor(this, 'AwsOtelAndroidDemoAppMonitor', {
      domain: 'amazonaws.com',
      name: 'aws-otel-android-demo-app-monitor',
    ...
    // Output the Identity Pool ID and AppMonitor ID for use in the Android app
    new cdk.CfnOutput(this, 'IdentityPoolId', {
      value: identityPool.ref,
      description: 'The ID of the Cognito Identity Pool',
      exportName: 'AwsOtelAndroidDemoIdentityPoolId',
    });

    new cdk.CfnOutput(this, 'AppMonitorId', {
      value: appMonitor.attrId,
      description: 'The ID of the CloudWatch RUM AppMonitor',
      exportName: 'AwsOtelAndroidDemoAppMonitorId',
    });

    new cdk.CfnOutput(this, 'DemoBucketName', {
      value: demoBucket.bucketName,
      description: 'The name of the S3 bucket',
      exportName: 'AwsOtelAndroidDemoBucketName',
    });

    new cdk.CfnOutput(this, 'Region', {
      value: this.region,
      description: 'The AWS region',
      exportName: 'AwsOtelAndroidDemoRegion',
    });
  }
}
