...
| otelResourceAttributes                 | object         | No       | Key-value pairs to be used as custom OpenTelemetry resource attributes                                  | N/A     | {"deployment.environment": "staging"}  |
| otelResourceAttributes.service.version | string         | No       | A special resource attribute you can add to filter on deployed app versions in RUM console              | N/A     | "1.0"                                  |
| otelResourceAttributes.service.name    | string         | No       | A special resource attribute to customise app name; if not provided, SDK will discover a best fit value | N/A     | "MyApplication"                        |
